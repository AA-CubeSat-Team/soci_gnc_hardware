...
#define DIFF_TEMP_BIAS_COE                                                     \
  0 // if the gyroscopes have different temperature bias and sensitivity
    // coefficients.
...
typedef struct _Gyro {
  ...
  lpi2c_master_transfer_t
      *gyroTransfer; /* gyroscope i2c transfer structure pointer*/
#endif
...
/* lpi2c_master_transfer_t gyroTransfer1 gyroscope i2c transfer structure
 * pointer*/
...
/* lpi2c_master_transfer_t gyroTransfer2 gyroscope i2c transfer structure
 * pointer*/
/* lpi2c_master_transfer_t gyroTransfer3 gyroscope i2c transfer structure
 * pointer*/
#endif
