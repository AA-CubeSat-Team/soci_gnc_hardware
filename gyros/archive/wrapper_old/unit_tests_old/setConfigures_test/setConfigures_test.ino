...
void loop() {
  ...
  Serial.print("Reference FSR: ");
  Serial.println(FSR);
  Serial.print("Reference ODR: ");
  Serial.println(ODR);

  setConfigures();
  
  int readFSR = readReg(FXAS21002C_H_CTRL_REG0);
  Serial.print("Read FSR: ");
  ...
  int readODR = readReg(FXAS21002C_H_CTRL_REG1);
  readODR = readODR>> 2;
