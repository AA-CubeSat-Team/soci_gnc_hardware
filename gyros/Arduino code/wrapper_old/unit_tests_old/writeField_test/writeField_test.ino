...
void loop() {
  int referenceField = 0b101;
  int lastBit = 2;
  int numBit = 3;
  int referenceValue = 0b10100;
  ...
  int referenceField1 = 0b1011;
  int referenceValue1 = 0b101100;
  int lastBit1 = 2;
  int numBit1 = 4;
    Serial.print("Reference value1: ");
  Serial.println(referenceValue1, BIN);
...
//void standby()
//{
//  writeField(FXAS21002C_H_CTRL_REG1, 0, 2, 0);
//}
//
