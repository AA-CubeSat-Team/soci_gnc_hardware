...
## Generated on : Sun Feb 21 19:04:13 2021
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduinoTest
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduinoTest
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/shared/svd/include -I$(START_DIR)/arduinoTest_grt_rtw -I/Users/willpope/Documents/MATLAB/AACT/SimIO -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=arduinoTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/MW_arduinoI2C.cpp $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/arduinoTest_grt_rtw/arduinoTest.c $(START_DIR)/arduinoTest_grt_rtw/arduinoTest_data.c $(START_DIR)/arduinoTest_grt_rtw/rtGetInf.c $(START_DIR)/arduinoTest_grt_rtw/rtGetNaN.c $(START_DIR)/arduinoTest_grt_rtw/rt_nonfinite.c
...
OBJS = MW_arduinoI2C.o rt_logging.o arduinoTest.o arduinoTest_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/arduinoTest_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/arduinoTest_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
