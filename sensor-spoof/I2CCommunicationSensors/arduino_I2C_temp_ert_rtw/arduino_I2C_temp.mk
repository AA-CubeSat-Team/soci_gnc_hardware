###########################################################################
## Makefile generated for Simulink model 'arduino_I2C_temp'. 
## 
## Makefile     : arduino_I2C_temp.mk
## Generated on : Sun Feb 21 18:42:07 2021
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_I2C_temp.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/willpope/Desktop/AACT/soci_gnc_hardware/sensor-spoof/I2CCommunicationSensors
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_I2C_temp.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/shared/svd/include -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/arduino_I2C_temp_ert_rtw -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/arduinotargetdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/include -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/shared/externalmode_daemon/include -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src -I/Users/willpope/Documents/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/utility
...
DEFINES_ = -DMODEL=arduino_I2C_temp -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=59286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=arduino_I2C_temp -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : $(START_DIR)/arduino_I2C_temp_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/arduino_I2C_temp_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/arduino_I2C_temp_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
MW_ArduinoHWInit.o : /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


arduinoAVRScheduler.o : /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


Wire.o : /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/Wire.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


twi.o : /Users/willpope/Documents/MATLAB/SupportPackages/R2018b/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/utility/twi.c
	$(CC) $(CFLAGS) -o $@ $<
